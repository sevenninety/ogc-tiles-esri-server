...
exports.getBbox = mapServerJson => {
    ...
    const bbox = [[mapServerJson.fullExtent.xmin, mapServerJson.fullExtent.ymin, mapServerJson.fullExtent.xmax, mapServerJson.fullExtent.ymax]];
    return bbox;
};

exports.GetMapServiceName = () => {
    const mapServiceParts = process.env.ESRI_SERVICE.split("/");
